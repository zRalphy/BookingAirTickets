...
public class CreateUpdateAirportDto {
    ...
    @Size(min = 5, max = 150, message = "Airport name should have at least 5 and at most 150 characters.")
    private String name;
    @NotBlank(message = "Please enter your airport country.")
    @Size(min = 3, max = 100, message = "Country should have at least 3 and at most 100 characters.")
